...
# Define the base path for the joblib files
# This path needs to be correct for the standalone app. Use a fixed path relative to the Colab env.
base_path = '/content/drive/MyDrive/universidad/9 semestre/Análisis IA/Eco ride/'
